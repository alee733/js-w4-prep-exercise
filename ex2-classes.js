...
class Wallet {
  ...
  reportBalance() {
    console.log(
      `Name: ${this.name}, balance: ${eurosFormatter.format(this.#cash)}, daily withdrawals: ${eurosFormatter.format(this.#dayTotalWithdrawals)}/${eurosFormatter.format(this.#dailyAllowance)}`
    );
  }
}
